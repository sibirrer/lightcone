...
Ready to contribute? Here's how to set up `lightcone` for local development.

1. Fork the `lightcone` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/lightcone.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::

    $ mkvirtualenv lightcone
    $ cd lightcone/
...
3. The pull request should work for Python 3.5, 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.com/sibirrer/lightcone/pull_requests
